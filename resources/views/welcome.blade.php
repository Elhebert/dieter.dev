<x-layouts.app>
    <article>
        ...
        <section class="mt-16 prose leading-loose max-w-none">
            ...
            <p>And finally I joined Strapi as a Senior Backend Engineer. Soon after I started to work as a Lead Backend Engineer for the upcoming Strapi Cloud platform. Together with the CTO we build the architecture and put the foundation of the code base that is running Strapi Cloud. My day-to-day consists of mentoring other engineers, being a bridge between our engineering and product teams and to be a steward for the codebase.</p>
            </section>
        ...
        <section class="mt-16 prose leading-loose max-w-none">
            ...
            <p>
                I love board games. I've been in the hobby for about <time duration="PT208W">4 years</time> now. Proud owner of around 200 games I have transformed part of my living room into a gaming area.
            </p>
            ...
            <p>
                I also play Dungeons and Dragons. When the very first lockdown started in Germany I just started a campaign with some colleagues. Since I knew the most I took the role of the Dungeon Master. We played a year-long campaign that finishes end of <time datetime="06-2021">June 2021</time>.
            </p>
        </section>
    </article>
</x-layouts.app>
